                        ...
                        @auth
                            ...
                            <div class="relative group">
                                <button id="userMenuBtn"
                                    ...
                                    <div
                                        class="w-8 h-8 md:w-9 md:h-9 rounded-full overflow-hidden border-2 border-[#EB8F42]">
            ...
            <div>
                ...
                <div class="flex gap-3 mt-4 text-xl text-[#e5d3c5]">
                    <a href="https://www.facebook.com" target="_blank"><i
                            class="fa-brands fa-facebook transition hover:scale-110 hover:text-white"></i></a>
                    <a href="https://web.whatsapp.com" target="_blank"><i
                            class="fa-brands fa-whatsapp transition hover:scale-110 hover:text-white"></i></a>
                    <a href="https://www.instagram.com" target="_blank"><i
                            class="fa-brands fa-instagram transition hover:scale-110 hover:text-white"></i></a>
                </div>
            </div>
        </div>
