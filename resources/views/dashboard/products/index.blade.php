                        ...
                        <form action="{{ URL::current() }}" method="get" class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center col-12">
                                ...
                                <div class=" ml-4" style="width:200px">
                                    ...
                                    firstOne="all Product" :options="['active' => 'Active', 'archive' => 'Archive']" />
                                </div>
                                <div class="ml-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                @if ($products->isNotEmpty())
                                    <h3 class="card-title">Product number ({{ $products->count() }})</h3>
                                @endif
                                <div class="card-tools">
                                    <div>
                                        <a href="{{ route('admin.product.create') }}" class="m-2"><i
