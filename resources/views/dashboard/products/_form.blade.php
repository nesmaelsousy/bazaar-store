...
<div class="section-block">
    ...
    <div class="d-flex align-items-start gap-3">
        ...
        <div class="row g-3 flex-1 ml-5">
            ...
            <div class="col-md-6 mt-2">
                <x-form.select label="Store Owner" name="store_id" :options="$stores"
                    firstOne="Select product Owner"
                    :oldVal="old('store_id', $product->store_id ?? '')" />
            </div>

            <div class="col-md-6 mt-2">
                <x-form.input label="product Price " name="price" type="number"
                    placeholder="e.g. 100"
            ...
            <div class="col-md-6 mt-2">
                <x-form.select :options="$categories" label="category" name="category_id"
                    :oldVal="$product->category_id" firstOne="Select category" />
            </div>
            <div class="col-md-12 mt-2">
                <x-form.textarea label="description" name="description" type="text" placeholder="e.g. product bazaar description"
                    :oldVal="old('description', $product->description ?? '')" />
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <div class="toggle-group">
                ...
                <div class="toggle-btn {{ old('status', $product->status ?? 'active') == 'archive' ? 'active-green' : '' }}"
