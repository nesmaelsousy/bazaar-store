    ...
    <div class="content-wrapper">
        <div class="p-5">
            ...
            <div class="d-flex align-items-center gap-3 mb-1">
                ...
                <div>
                    <h2 class="page-title mb- 0">Edit a {{ $store->name }} </h2>
            ...
            {{-- Form --}}
            <form action="{{ route('dashboard.store.update',$store->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                @include('dashboard.stores._form',['store' => $store])
            </form>
        </div>
    </div>
@endsection
