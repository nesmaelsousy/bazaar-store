                        ...
                        <div class="d-flex gap-2 align-items-center col-12">
                            <div>
                                <div class="input-group input-group-sm">
                                    <x-form.input name="name" placeholder="Search by store name"
                                        :oldVal="request('name')"
                                        style="width:500px" />
                            ...
                            <div class=" ml-4" style="width:200px">
                                <x-form.select name="status"
                                    firstOne="all store" :options="['active' => 'Active', 'archive' => 'Archive']" />
                            </div>
                            <div class="ml-4">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title">store number ({{ $stores->count() }})</h3>
                            @endif
                            <div class="card-tools">
                                <div>
                                    <a href="{{ route('admin.store.create') }}" class="m-2"><i
