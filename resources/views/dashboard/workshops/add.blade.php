...
<div class="content-wrapper">
    <div class="p-5">
        ...
        <div class="d-flex align-items-center gap-3 mb-1">
            ...
            <div>
                <h2 class="page-title mb- 0">Add a new workshop</h2>
                <p class="page-subtitle mb-0">Fill in the details below to create a new workshop 
        ...
        <form action="{{ route('admin.workshop.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @include('dashboard.workshops._form')
        </form>
    </div>
</div>
@endsection
