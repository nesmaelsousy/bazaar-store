...
@section('content')
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="header-card text-center py-4">
                            ...
                            <div class="position-relative d-inline-block">
                                <label for="avatar" class="cursor-pointer">
                                    <img name="avatar" style="object-fit:cover;"
                                        src="{{ asset(optional($admin->image)? 'storage/'.$admin->image : 'admin_assets_rtl/images/avatars/avatar-removebg-preview.png') }}"
                    ...
                    <div class="d-none">
                        <x-form.input type='file' accept=".jpg,.png,.svg,.jpeg" name="avatar" :oldimage="$admin->image" />
                    </div>
  ...
  <hr style="color: #cdcdcd">
    <div class="card-body">
        ...
        <div class="mb-3">
            <x-form.input label="البريد الإلكتروني" name="email" type="email" :oldVal="old('email', $admin->email)" disable='true'
                disabled />
        ...
        <!-- تأكيد كلمة المرور -->
        <x-form.input label="تأكيد كلمة المرور" name="password_confirmation" type="password" value="password" />
...
@section('js')
    <script>
        ...
        if(avatar.src.includes('admin_assets_rtl/images/avatars/avatar-removebg-preview.png')){
