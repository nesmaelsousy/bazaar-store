<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background: #5C3D2E; border-bottom: 2px solid #4A3226;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="border-radius: 12px; border: 1px solid #E8DCD2; box-shadow: 0 8px 25px rgba(92, 61, 46, 0.15);">

                @forelse($latestMessages ?? [] as $latestMessage)
                    <a href="{{ route('admin.contact.show', $latestMessage->id) }}" class="dropdown-item" style="padding: 12px 16px; transition: all 0.2s;" onmouseover="this.style.background='#FBF7F4'" onmouseout="this.style.background='transparent'">

                        <div class="media">

                            {{-- Avatar --}}
                            <div class="img-size-50 mr-3 img-circle d-flex align-items-center justify-content-center text-white" style="background: #8B6B4A; width: 50px; height: 50px; border-radius: 50%; font-weight: 700; font-size: 1rem; flex-shrink: 0;">
                                {{ Str::substr($latestMessage->fullname, 0, 2) }}
                            </div>

                            <div class="media-body">
                                <h3 class="dropdown-item-title" style="font-weight: 600; color: #5C3D2E; margin-bottom: 4px;">
                ...
                @empty
                    <div class="dropdown-item text-center" style="color: #8B6B4A; padding: 20px;">
                        <i class="far fa-envelope-open" style="font-size: 1.5rem; display: block; margin-bottom: 8px; color: #C4A88C;"></i>
                        No messages
                    </div>
                @endforelse

                <a href="{{ route('admin.contact.index') }}" class="dropdown-item dropdown-footer" style="background: #FBF7F4; color: #5C3D2E; font-weight: 600; text-align: center; padding: 12px; border-radius: 0 0 12px 12px; transition: all 0.2s;" onmouseover="this.style.background='#E8DCD2'" onmouseout="this.style.background='#FBF7F4'">
                    See All Messages
        ...
        <li class="nav-item dropdown user-menu mr-5">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="border-radius: 12px; border: 1px solid #E8DCD2; box-shadow: 0 8px 25px rgba(92, 61, 46, 0.15); padding: 0;">
